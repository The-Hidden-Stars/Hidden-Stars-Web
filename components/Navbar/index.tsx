...
const Navbar = () => {
    return (
        <nav className="fixed w-full bg-white border-b border-solid border-b-gray-500 px-3 sm:px-4 py-2.5 dark:bg-gray-900 backdrop-blur-md dark:bg-opacity-75">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
            <Link href="/">
                <a className="flex items-center space-x-3">
                    <Image src="/svg/logo.svg" width={25} height={25} />
            ...
            <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-3">
                ...
                <li>
                    <a href="#" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Our Misson</a>
                </li>
                <li>
